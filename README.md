...
- Led 3 enterprise platform/license migrations involving database migration, DNS cutover, environment provisioning, QA, production debugging, and stakeholder reporting.
...
Pharmacy management web app built with Flask and MySQL. Includes inventory, sales, returns, purchase orders, role-based access, and analytics reports.
